  ...
  return (
    <div className="rx-live">
      ...
      <aside className="rx-live__side">
        ...
        <ul className="max-h-[40vh] space-y-2 overflow-y-auto overscroll-contain lg:max-h-none lg:flex-1">
          {filtered.map((l) => {
      ...
      {/* Map */}
      <section className="rx-live__map">
        {(error || mapError) && (
